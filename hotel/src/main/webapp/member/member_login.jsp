...
<body class="w3-white">
	...
	<!-- Page content -->
	<div
		style="border-style: solid; border-color: #4CAF50; margin-top: 6%; width: 400px; height: 700px; margin-bottom: 6%; margin-left: 36%; border-radius: 40px 40px 40px 40px;">
		<div data-aos="fade-up" style="padding-top: 47%; padding-bottom: 2%;">
			<h2
				style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 50px; margin-left: 125px;">
				로그인</h2>
		</div>
		<form method="post" action="../memberLoginServlet"
			style="margin-bottom: 20%; margin-left: 36px; margin-right: 55px;">
			...
			<div class="form-group" style="padding-left: 27px;">
				<input type="submit" value="Login"
					...
					style="margin-top: 10px; width: 275px; border-radius: 10px 10px 10px 10px; background-color: #4CAF50; color: white; border-color: white;">
			</div>
			<div class="form-group"
				style="width: 350px; text-align: center; padding-right: 24px; padding-top: 10px;">
